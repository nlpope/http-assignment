    ...
    return (
      <div className="App">
        ...
        <Switch>
          ...
          {/* courseId and courseTitle is an arbitrary name used to pass props */}
          {/* in the Course component call console.log(this.props.match) to see that it was picked up */}
          {/* <Route path="/courses/:courseId/" component={Course} /> */}
          <Route path="/courses" component={Courses} />
          {/* using 'render' instead of 'component' keeps from unnecessary remounting */}
